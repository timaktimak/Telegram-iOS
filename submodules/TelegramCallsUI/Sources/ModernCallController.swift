...
protocol ModernCallControllerNodeProtocol: AnyObject {
...
public final class ModernCallController: ViewController {
    private var controllerNode: ModernCallControllerNodeProtocol {
        return self.displayNode as! ModernCallControllerNodeProtocol
    }
    ...
    override public func loadDisplayNode() {
        if self.call.isVideoPossible {
            self.displayNode = ModernCallControllerNode(sharedContext: self.sharedContext, account: self.account, presentationData: self.presentationData, statusBar: self.statusBar, debugInfo: self.call.debugInfo(), shouldStayHiddenUntilConnection: !self.call.isOutgoing && self.call.isIntegratedWithCallKit, easyDebugAccess: self.easyDebugAccess, call: self.call)
        } else {
            // TODO: timur
